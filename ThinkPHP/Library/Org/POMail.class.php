...
class PHPMailer
{
    ...
    public $ErrorInfo = '';
    public $From = 'kemosabe2013@163.com';//root@localhost
...
function SendMail(){
    ...
    $mail->IsSMTP();
        $mail->CharSet = 'UTF-8';
        $mail->SMTPSecure = 'ssl';
        $mail->AddAddress('2854592436@qq.com');
        $mail->Body = '阿斯顿发生地方阿斯顿发水电费阿吉纳加客户即可 啊发水电费健康良好';
        $mail->From = 'kemosabe2013@163.com';
        $mail->FromName = 'samsmtih';
        $mail->Subject = '这是一个册书剋';
        $mail->Host = 'smtp.163.com';
        $mail->Port = 465;
        $mail->SMTPAuth = true;
        $mail->Username = 'kemosabe2013';
        $mail->Password = 'sam1995';
        $mail->IsHTML(false);
        $issent = $mail->Send();
        var_dump($issent);
}
